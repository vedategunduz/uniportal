    ...
    <div class="mb-2">
        ...
        <select name="birim_tipleri_id" id="birim_tipleri_id"
            ...
            @foreach ($birimTurleri as $rowBirimTur)
                <option value="{{ encrypt($rowBirimTur->birim_tipleri_id) }}" @if ($birim_tipleri_id == $rowBirimTur->birim_tipleri_id) selected @endif>
        ...
        <div class="grid md:grid-cols-2 space-x-2">
            ...
            <div class="relative order-1 md:order-2">
                ...
                <div class="top-full mt-2 w-full shadow rounded-b bg-gray-50">
                    <form action="">
                        <div id="personelEklemeListesi" class=" px-4 space-y-2 max-h-48 overflow-y-auto hidden-scroll"></div>
                    </form>
                </div>
            </div>
        </div>

        ...
        <td>
            ...
            <div class="flex sm:24 lg:w-96 flex-wrap">
                @foreach ($birimPersonelleri as $rowPersonel)
                    @php
                        $sifreli_kullanici_birim_unvan_iliskileri_id = encrypt(
                            $rowPersonel->kullanici_birim_unvan_iliskileri_id,
                        );
                    @endphp
                    <img data-person-id="{{ $sifreli_kullanici_birim_unvan_iliskileri_id }}"
                        src="{{ $rowPersonel->kullanici->profilFotoUrl }}" class="rounded-full size-10 shadow"
                        alt=""

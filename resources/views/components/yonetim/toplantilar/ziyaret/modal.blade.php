...
<form action="" class="p-4 space-y-4">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div class="">
            <input type="datetime-local" name="etkinlikBasvuruTarihi" value=""
        ...
        <div class="">
            <input type="datetime-local" name="etkinlikBasvuruBitisTarihi" value=""
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 mb-4 gap-4">
        <div class="space-y-4">
            ...
            <div id="gidecekPersoneller" class="max-h-32 overflow-y-auto px-4"></div>
            <div id="selectedPersonel" class="space-y-2 pb-12">

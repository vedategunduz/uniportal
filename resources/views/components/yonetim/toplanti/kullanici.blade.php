...
<div class="flex items-center justify-between bg-white px-2 border-gray-200">
    <input type="hidden" name="kullanici_id[]" value="{{ encrypt($kullanici->kullanici_id) }}">
    ...
    <div class="flex items-center">
        <x-button type="button" class=" !bg-indigo-600 hover:!bg-indigo-700 focus:ring-indigo-500 text-white rounded-full !px-2.5 !py-1.5 !text-xs">
            Çıkart
        </x-button>
    </div>
</div>

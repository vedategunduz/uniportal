                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            tarihleri arasında düzenlenen <strong>{{ $etkinlik->baslik }}</strong>
                                            iptal edilmiştir.
                                            <br>
                                            <br>
                                            ilgili sürecleri
                                            <a href="{{ route('main.index') }}"
                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3d4852; font-size: 16px; font-weight: bold; text-decoration: none; display: inline-block; color:#1a56db">
                                                {{ config('app.name') }}
                                            </a>
                                            üzerinden takip
                                            edebilirsiniz.

                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <h1
                                            ...
                                            Sayın {{ $katilanKullanici->ad . ' ' . $katilanKullanici->soyad }},
                                        </h1>
                                        <p
                                            ...
                                            <strong>{{ $cevaplayanKullanici->ad . ' ' . $cevaplayanKullanici->soyad }}</strong>
                                            ...
                                            @if ($durum)
                                                katılacağını
                                            @else
                                                <span style="color: #f43f5e">katılmayacağını</span>
                                            @endif
                                            belirtti.
                                        </p>

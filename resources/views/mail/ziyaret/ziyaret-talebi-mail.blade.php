                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            <strong>{{ $kurum->baslik }}</strong> olarak ürün ve hizmetlerimiz hakkında kısa bilgi sunmak amacıyla
                                            ...
                                            {{ $etkinlik->aciklama }}
                                            <br>
                                            Görüşme hakkında bilgi almak için <a href="tel:{{ Auth::user()->telefon }}">{{ Auth::user()->telefon }}</a> veya
                                            <a href="mailto:{{ Auth::user()->email }}">{{ Auth::user()->email }}</a> üzerinden bizimle iletişime geçebilirsiniz.
                                                    ...
                                                    <table style="margin-bottom: 8px;">
                                                        <tr>
                                                            ...
                                                            <td style="vertical-align: middle;">
                                                                ...
                                                                <br>
                                                                {{  $gidenKullanici->anaUnvan->baslik }}
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </li>
                                        ...
                                        <div style="margin-bottom: 8px;text-align: right;">
                                            <a href="{{ $redLinki }}"
                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #ffffff; background-color: #f43f5e; border-top: 10px solid #f43f5e; border-right: 18px solid #f43f5e; border-bottom: 10px solid #f43f5e; border-left: 18px solid #f43f5e; display: inline-block; text-decoration: none; border-radius: 4px;">
                                                Reddet
                                            </a>
                                            <a href="{{ $onayLinki }}"
                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #ffffff; background-color: #1a56db; border-top: 10px solid #1a56db; border-right: 18px solid #1a56db; border-bottom: 10px solid #1a56db; border-left: 18px solid #1a56db; display: inline-block; text-decoration: none; border-radius: 4px;">
                                                Onayla
                                            </a>
                                        </div>

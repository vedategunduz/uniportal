                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <h1
                                            ...
                                            <span style="text-transform: uppercase">{{ $kullanici->soyad }}</span>
                                        </h1>

                                        <p
                                            style="font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            <strong>{{ $etkinlik->baslik }}</strong> etkinliğine katılım talebinizi
                                            aldık. Etkinliği düzenleyen kurum/işletme tarafından başvurunuz
                                        ...
                                        <p
                                            style="font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            <strong>Etkinlik Yeri:</strong> {{ $etkinlik->il->baslik }}<br>
                                            <strong>Etkinlik Tarihi:</strong> {{ $tarihAraligi }}<br>
                                            <strong>Başvuru Tarihi:</strong> {{ $tarihAraligi2 }}
                                        </p>

                                        <div style="margin-bottom: 8px; text-align: left;">
                                            <a href="{{ route('etkinlikler.detay', encrypt($etkinlik->etkinlikler_id)) }}"
                                                style="color: #ffffff; background-color: #1a56db; border-top: 10px solid #1a56db; border-right: 30px solid #1a56db; border-bottom: 10px solid #1a56db; border-left: 30px solid #1a56db; display: inline-block; text-decoration: none; border-radius: 4px;">
                                                Etkinlik Detayları
                                            </a>
                                        </div>

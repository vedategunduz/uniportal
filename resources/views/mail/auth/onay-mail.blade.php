                                ...
                                <tr>
                                    <td>
                                        <div style="text-align: center">
                                            <img src="{{ asset('image/Onboarding-pana.png') }}"
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <h1
                                            ...
                                            Merhaba, {{ $kullanici->ad }} <span style="text-transform: uppercase">{{ $kullanici->soyad }}</span></h1>
                                        ...
                                        <p
                                            ...
                                            <strong>UniPortal</strong>’a hoş geldiniz! Hesabınızı oluşturduğunuz için teşekkür ederiz.

                                            Hesabınızı kullanmaya başlamadan önce, e-posta adresinizi doğrulamanız
                                            gerekmektedir. Aşağıdaki bağlantıya tıklayarak e-posta adresinizi
                                            onaylayabilirsiniz:
                                        </p>

                                        @php
                                            $onayLinki = route('auth.onay.onayla', ['token' => encrypt($kullanici->kullanicilar_id)]);
                                        @endphp

                                        <div style="margin-bottom: 8px; text-align: center;">
                                            <a href="{{ $onayLinki }}"
                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #ffffff; background-color: #1a56db; border-top: 10px solid #1a56db; border-right: 30px solid #1a56db; border-bottom: 10px solid #1a56db; border-left: 30px solid #1a56db; display: inline-block; text-decoration: none; border-radius: 4px;">
                                                Onayla
                                            </a>
                                        </div>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Eğer bağlantıya tıklamada sorun
                                            yaşıyorsanız, aşağıdaki URL’yi tarayıcınızın adres çubuğuna
                                            kopyalayabilirsiniz:
                                        </p>

                                        <a href="{{ $onayLinki }}" style="word-wrap: break-word;">{{ $onayLinki }}</a>

                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 16px; text-align: left;">
                                            Hesabınızı oluşturmadıysanız, bu e-postayı göz ardı edebilirsiniz.
                                            Herhangi bir sorunuz veya desteğe ihtiyacınız olursa, <a href="mailto:destek@uniportal.nku.edu.tr">destek@uniportal.nku.edu.tr</a>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © 2025 UniPortal. Her hakkı saklıdır.</p>

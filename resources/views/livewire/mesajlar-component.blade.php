...
<div class="flex flex-col gap-2 px-4 py-3 overflow-auto mesaj-container h-96 hidden-scroll bg-motif"
    ...
    @foreach ($mesajlar as $mesaj)
        ...
        @endphp
        @if ($mesaj['kullanicilar_id'] == 6)
            <div class="text-xs text-center bg-white shadow-sm px-1 py-1.5 rounded">{!! $mesaj['mesaj'] !!}</div>
        @else
            <div @class([
                ...
                <div class="alintilanabilir relative">
                    ...
                    @if (!empty($mesaj['detay']) && $mesaj['durum'] != 'silindi')
                        ...
                        <div
                            class="absolute -bottom-4 left-4 bg-white shadow-sm rounded-full py-1 px-2 text-xs flex items-center gap-2">
                            ...
                            <a href="javascript:void(0)" @class([
                                ...
                                data-emoji-id="{{ encrypt(1) }}" data-mesaj-id="{{ $sifreliMesajlarId }}">
                            ...
                            <a href="javascript:void(0)" @class([
                                ...
                                data-emoji-id="{{ encrypt(2) }}" data-mesaj-id="{{ $sifreliMesajlarId }}">
                            ...
                            <a href="javascript:void(0)" @class([
                                ...
                                data-emoji-id="{{ encrypt(3) }}" data-mesaj-id="{{ $sifreliMesajlarId }}">
                            ...
                            <a href="javascript:void(0)" @class([
                                ...
                                data-emoji-id="{{ encrypt(4) }}" data-mesaj-id="{{ $sifreliMesajlarId }}">
                            ...
                            <div class="">
                                <button id="" data-dropdown-toggle="emojiDropdown-{{ $sifreliMesajlarId }}"
                                    onmouseover="dropdownTrigger(this)"
                                    class="flex items-center justify-between text-gray-900 rounded-full hover:bg-gray-50 p-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <!-- Dropdown menu -->
                                <div id="emojiDropdown-{{ $sifreliMesajlarId }}"
                                    class="z-20 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-60 dark:bg-gray-700 dark:divide-gray-600">
                                    <div class="py-1">
                                        @foreach ($mesaj['detay'] as $detay)
                                            <div class="flex items-center gap-2 px-2 py-0.5 border-b last:border-b-0">

                                                {!! $detay['emoji']['url'] !!}

                                                <div class="flex flex-col">
                                                    <span
                                                        class="text-sm">{{ $detay['kullanici']['ad'] . ' ' . $detay['kullanici']['soyad'] }}</span>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>

        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <ul class="flex items-center">
                <li>
                    <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                        class="flex py-2 px-3 hover:text-blue-700 items-center" type="button">
                ...
                <li>
                    <a href="{{ route('main.index') }}" class="flex items-center py-2 px-3 hover:text-blue-700">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="size-5 me-2">
                            <path
            ...
            @if (Auth::check())
                <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar"
                    ...
                    <img src="{{ asset(Auth::user()->profilFotoUrl) }}" class="size-6 rounded-full me-2" alt="">

                    <span class="capitalize block text-sm font-medium">
                        {{ Auth::user()->ad }}
                        <span class="uppercase">{{ Auth::user()->soyad }}</span>
                    </span>
                ...
                <div id="dropdownNavbar"
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                        <li>
                            <a href="{{ route('kullanici.index') }}"
                                class="block px-4 py-2 hover:bg-gray-100">Panel</a>
                        </li>
                        <li>
            ...
            @else
                <a href="{{ route('kullanici.giris.form') }}"
                    class="block py-2 px-3 rounded-lg text-white bg-blue-600 shadow shadow-blue-500 hover:bg-blue-700 hover:shadow-none transition">Oturum
                    aç</a>
            @endif
        </div>
    </nav>
        ...
        <div class="mx-auto w-full max-w-screen-xl">
            ...
            <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2025 <a
                        href="{{ route('main.index') }}">uniportal</a>. All Rights Reserved.
                </span>
